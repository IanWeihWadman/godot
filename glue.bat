cd /D "%~dp0"
scons p=windows tools=yes module_mono_enabled=yes mono_glue=no optimize=debug
...
scons p=windows tools=yes module_mono_enabled=yes mono_glue=yes debug_symbols=True optimize=debug